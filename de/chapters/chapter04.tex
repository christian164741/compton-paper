...
\subsection{Für das masseslose Photon gilt: }
\begin{align*}
...
\begin{align*}
	...
	cp_\gamma+m_ec^2-cp'_\gamma&=\sqrt{m^2_ec^4+c^2p^2_\gamma+c^2{p'}^2_{\gamma y}-2c^2p_\gamma p'_\gamma \cos(\theta)}\quad /\text{quatrieren}\\
...
\textbf{Relative Compton-Verschiebung in Abhängigkeit von der Wellenlänge.}
\begin{figure}[h]
	\centering
	\begin{tikzpicture}
		\begin{axis}[
