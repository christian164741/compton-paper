...
\newcommand{\PaperDOI}{\emph{DOI (Zenodo)}: \texttt{10.5281/zenodo.17648186}}
\newcommand{\PaperISBNPDF}{\emph{ISBN (Print)}: 978-3-912302-05-9}
\newcommand{\PaperISBNEPUB}{\emph{ISBN (E-Book)}: 978-3-912302-04-2}
...
\begin{document}
	...
	\href{https://doi.org/10.5281/zenodo.17648186}{\texttt{https://doi.org/10.5281/zenodo.17648186}}
	...
	\vfill
\begin{center}
	\textit{Math \& Physics Paper Series – Open Access unter}\\[3pt]
	\href{https://mathandphysics.de}{\texttt{https://mathandphysics.de}} 
	\,|\, 
	\href{https://zenodo.org/communities/christian-copilot/records?q=&l=list&p=1&s=10&sort=newest}{\texttt{Zenodo: Christian \& Co-Pilot – Math \& Physics Open Science Collection}}
\end{center}
